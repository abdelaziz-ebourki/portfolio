...
function useResizeObserver(
  callback: () => void,
  elements: Array<RefObject<HTMLDivElement | HTMLUListElement | null>>,
...
type LogoLoopProps = {
  ...
  renderItem?: (logo: LogoLoopLogo, key: string) => ReactNode
  ariaLabel?: string
  className?: string
  style?: CSSProperties
}
