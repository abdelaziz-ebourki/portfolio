...
export const ui = {
  ...
  projects: {
    ...
    docs: { en: "Docs", fr: "Docs", ar: "التوثيق" },
    design: { en: "Design", fr: "Design", ar: "التصميم" },
    video: { en: "Video", fr: "Vidéo", ar: "فيديو" },
    prevSlide: { en: "Previous slide", fr: "Diapositive précédente", ar: "الشريحة السابقة" },
    nextSlide: { en: "Next slide", fr: "Diapositive suivante", ar: "الشريحة التالية" },
    ...
    statusMaintained: { en: "Maintained", fr: "Maintenu", ar: "يُصان" },
    statusArchived: { en: "Archived", fr: "Archivé", ar: "مؤرشف" },
    kindPersonal: { en: "Personal", fr: "Personnel", ar: "شخصي" },
    kindAcademic: { en: "Academic", fr: "Académique", ar: "أكاديمي" },
    kindClient: { en: "Client", fr: "Client", ar: "لعميل" },
